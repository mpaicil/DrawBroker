...
public class DrawFactoryTest {
    ...
    public void verifyTheCorrectExtractionOfTheLoto(){
        Loto loto = drawFactory.retrieveLoto();
        assertThat(loto.getJokerNumber(),is(12));
    }

    @Test
    public void verifyTheCorrectExtractionNumberForLoto(){
        Integer[] extractValues = drawFactory.extractLotoNumbers();
